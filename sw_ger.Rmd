...
The plot for Voss "Faust" -- the play with the highest R²=`r df["voss-faust"==df$name, ]$Rsqrt`.
...
The plot for Goethe "Götz von Berlichingen mit der eisernen Hand", R²=`r df["goethe-goetz-von-berlichingen-mit-der-eisernen-hand"==df$name, ]$Rsqrt`.
```{r}
